...
const firebaseConfig = {
  apiKey: "AIzaSyCkWBLV-kWeWt6Jrc8wrvKNZ-Nq_0hl3iU",
  authDomain: "it-sysarch32-store-aboyme.firebaseapp.com",
  projectId: "it-sysarch32-store-aboyme",
  storageBucket: "it-sysarch32-store-aboyme.appspot.com",
  messagingSenderId: "385234697198",
  appId: "1:385234697198:web:feb6bf29daec32f8002cff",
  measurementId: "G-1EGP2VGEMP"
};
...
const FirestoreExample = () => {
  ...
  <div className="d-flex align-items-center justify-content-center">
    ...
    <h2 className="mb-0" style={{ fontSize: '36px', color: '#FFD700' }}>Featured</h2> {/* Larger header font */}
  </div>
...
>
  ...
  <p className="text-white mt-3 mb-0">The items in store are available now for you to buy. Buy yours now!!</p> {/* White supporting text */}
</div>
